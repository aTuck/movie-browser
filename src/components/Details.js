  ...
  return (
    <DetailsContainer>
      ...
      <HeaderContainer>
        ...
        <MainDetailsCard>
          <TitleContainer>
            <Title releasedate={props.movie.Released}>
              {props.movie.Title}
            </Title>
          </TitleContainer>
      ...
      <AdditionalDetailsContainer>
        ...
        <DetailsCardContainer>
          {props.movie.Actors &&
            props.movie.Actors.split(",").map(actorName => {
              return (
                <DetailsCard key={actorName}>
        ...
        <DetailsCardContainer>
          {props.movie.Ratings &&
            props.movie.Ratings.map(rating => {
              return (
                <DetailsCard key={rating.Source}>
                  <DetailsCardText>{rating.Source}</DetailsCardText>
                  <p>{rating.Value}</p>
                  {rating.Source === "Internet Movie Database" ? (
                    <p>Votes: {props.movie.imdbVotes}</p>
                  ) : null}
                </DetailsCard>
              );
            })}
